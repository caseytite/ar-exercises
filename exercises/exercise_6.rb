...
@store1.employees.create(first_name: "Owen", last_name: "GT", hourly_rate: 150)
...
@store2.employees.create(first_name: "Fluffykins", last_name: "GT", hourly_rate: 200)
...
@store4.employees.create(first_name: "Freddy", last_name: "GT", hourly_rate: 150)
...
@store5.employees.create(first_name: "Huck", last_name: "GT", hourly_rate: 150)
...
@store6.employees.create(first_name: "Wyatt", last_name: "GT", hourly_rate: 150)